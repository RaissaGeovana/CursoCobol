      ...
      ******************************************************************
       ...
       FD DADOSR.
       01 RG-DADOS-R.
          02 COD-DADOS-R    PIC 999.
          02 NOM-DADOS-R    PIC X(20).
      ...
      ***********ARQUIVO DE DADOSF **************
       ...
       P0200-PROCESSA.
           ...
           INITIALISE RG-DADOS-R REPLACING ALPHANUMERIC BY SPACES
                                           NUMERIC      BY ZEROES.
           ...
           PERFORM UNTIL FIM-OK AND FIM-OK-1
            EVALUATE TRUE
              WHEN COD-DADOS < COD-DADOS-1
                   MOVE RG-DADOS TO RG-DADOS-R
                   PERFORM P0203-GRAVA-DADOSR THRU P0203-FIM
                   PERFORM P0201-LER-DADOS    THRU P0201-FIM
              WHEN COD-DADOS = COD-DADOS-1
                   MOVE RG-DADOS-1 TO RG-DADOS-R
                   PERFORM P0203-GRAVA-DADOSR THRU P0203-FIM
                   PERFORM P0201-LER-DADOS    THRU P0201-FIM
                   PERFORM P0202-LER-DADOS1   THRU P0202-FIM
              WHEN COD-DADOS > COD-DADOS-1
